                    ...
                    <ul style="overflow: scroll; height: 400px;">
                        ...
                        ?>
                                <li>
                                    ...
                                    <strong>Beneficiary Name:</strong> <?= $row['trensaction_type'] ?><br>
                                    <strong>Beneficiary Account Number:</strong> <?= $row['montant'] ?><br>
                                    <strong>Amount:</strong> <?= $row['source'] ?><br>
                                    <strong>Reference:</strong> <?= $row['statut'] ?><br>
                                    <strong>Status:</strong> <?= $row['code_raison'] ?><br>
                                    <strong>Date:</strong> <?= $row['create_at'] ?><br>
                                    <!--We will put the id of each payment operation in this link-->
